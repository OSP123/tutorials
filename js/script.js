	...
	var appID = "7c3832ce234904f30881f09806b7a6d7";
   	...
   	$(".query_btn").click(function(){
    	...
    	if ($(this).prev().attr("placeholder") == "City") {
    		var weather = "https://openweathermap.org/data/2.5/weather?q=" + query_param + "&APPID=" + appID;
    	} else if ($(this).prev().attr("placeholder") == "Zip Code") {
    		var weather = "https://openweathermap.org/data/2.5/weather?zip=" + query_param + "&APPID=" + appID;
